...
namespace Exercicio1
{
    ...
    public class Program
    {
        ...
        {
            // Create a new empty list of players
            ...
            foreach (Player p in playerList)
            {
                ...
                if (p.Score > minScore)
                {
                    // ...add him to the new list of players
                    playersWithScoreGreaterThan.Add(p);
                }
            }

            // Return the list of players with score higher than the given
            // value; we can do this because List<T> implements IEnumerable<T>
